...
export default function WomenPage() {
    ...
    const getDataApi = async () => {
      ...
      const url = `https://api.bestbuy.com/v1/products((categoryPath.id=abcat0401000))?apiKey=${apiKey}&sort=salePrice.asc&show=name,salePrice,description,image,condition,url,sku&pageSize=20&format=json`;
  ...
  return (
    <div>
      <Banner bg={'banner--women'} title={'Capture every detail'} />
